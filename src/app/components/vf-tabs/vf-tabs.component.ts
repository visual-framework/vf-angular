...
export class VfTabsComponent {
            ...
            <div class="vf-tabs">
              <ul class="vf-tabs__list" data-vf-js-tabs>
                <li class="vf-tabs__item">
                  <a class="vf-tabs__link" href="/components/vf-tabs/#vf-tabs__section-nested--234548">Nested tab 1</a>
                </li>
                <li class="vf-tabs__item">
                  <a class="vf-tabs__link" href="/components/vf-tabs/#vf-tabs__section-nested--29974">Nested tab 2</a>
                </li>
              </ul>
            </div>
  ...
  public deepLinkTabsdata = [
    [
      { tab_title: `Section` },
      { tab_number: 99999 },
      { tab_heading: `Default` },
      { tab_content: `An <a href="/components/vf-tabs/#vf-tabs__section--88888">example deep link</a> loading this anchor will directly activate the neighbouring tab. <code>/vf-tabs#vf-tabs__section--88888</code>` }
    ],
    [
      { tab_title: `A Short Section` },
      { tab_number: 88888 },
